...
function ErrorAgregaUsuario() {
    ...
    <div className="Popup_container">
        ...
        <DialogContent className="Popup_container">
            ...
            <DialogContentText >
                <p className="Popup_text">El correo electrónico ingresado ya está asociado a una cuenta existente. Por favor, utiliza otro correo electrónico para registrarte.</p>
            </DialogContentText>
        </DialogContent>
